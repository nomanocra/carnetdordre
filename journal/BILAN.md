...
_Dernière mise à jour : 2026-09-17 19:53 UTC — 7 jour(s) de bourse clôturé(s)._

| | Perf. cumulée | Max drawdown | Capital engagé |
|---|---|---|---|
| **Track x2** | +0.37 % | -2.06 % | 1 699.92 USD |
| **Track x5** | +0.83 % | -5.68 % | 1 699.93 USD |
| QQQ sans levier | +0.09 % | -2.16 % | — |
| QQQ à levier x2 (même exposition que le track x2) | +0.17 % | -4.32 % | — |
| QQQ à levier x5 (même exposition que le track x5) | +0.43 % | -10.81 % | — |

**Comparaison à levier égal** : le track x2 bat QQQ x2 (+0.37 % vs +0.17 %) ; le track x5 bat QQQ x5 (+0.83 % vs +0.43 %).

## Statistiques de trading

- **Jours de bourse écoulés** : 7
- **Nombre de trades** : 34
- **Taux de réussite** : 41.2 %
- **Gain moyen (trades gagnants)** : 6.76 USD
...
- **QQQ, dernière clôture connue** : 717.73
